...
typedef b8 (*PFNOnEvent)(u16 code, void *sender, void *listenerInstance, eventContext data);
 ...
 */
FAPI b8 eventRegister(u16 code, void *listener, PFNOnEvent onEvent);
 ...
 */
FAPI b8 eventUnregister(u16 code, void *listener, PFNOnEvent onEvent);
 ...
 */
FAPI b8 eventFire(u16 code, void *sender, eventContext context);
